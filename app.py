...
Original file is located at
    https://colab.research.google.com/drive/1-AGMhx92wHlauWnlm98uIKtbSGE-QVYP
"""
...
if uploaded_file:
    ...
    if 'Population Urban' in data.columns:
        data.dropna(subset=['Population Urban'], inplace=True)
